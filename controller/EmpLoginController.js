...
class Emplogindetails{};
 Emplogindetails.Emplogin = function(req, res, next) {
...
con.execute_proc('call sp_EmpValidateLogin(?,?,?,?,?,?)',loginparameter,function(data) {
	console.log(data);
...
module.exports = Emplogindetails;