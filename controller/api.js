...
router.post('/lead-optin',function(req,res,next){
  var optin = require('../controller/OptinLeadController');
  optin.UpdateOptIN(req,res,next);
});
...
router.post('/liccombowrapper', function (req, res, next) { 
 console.log("12"); 
  var combo = require('../controller/UltraLakshyaController');  
   console.log("check");
  combo.licwrapper(req,res,next);
});
...
router.post('/loanrequest', function (req, res, next) { 
  var combo = require('../controller/LoanRequestController');
  combo.loanrequest(req,res,next);
});

router.post('/getloanrequest', function (req, res, next) { 
  var combo = require('../controller/LoanRequestController');
  combo.getloanrequest(req,res,next);
});
router.post('/Synclogin', function (req, res, next) { 
  var SyncContactLogin = require('../controller/SyncLoginController');
  SyncContactLogin.Synclogin(req,res,next);
});
...
router.post('/update-LS-Status', function (req, res, next) { 
  var combo = require('../controller/LoanRequestController');
  combo.updateLSLoanStatus(req,res,next);
});
router.post('/send-da-msg', function (req, res, next) { 
  var combo = require('../controller/DAController');
  combo.senddamessage(req,res,next);
});
router.post('/get-loan-lead-dataforrb', function (req, res, next) { 
  var combo = require('../controller/LoanRequestController');
  combo.getloanleaddataforrb(req,res,next);
});
...
router.post('/get-ticket-comments', function (req, res, next) { 
  var ticket = require('../controller/RaiseATicketController');
  ticket.getTicketComment(req,res,next);
});
...
router.post('/contact-lead-disposition-master', function (req, res, next) { 
  var contacts = require('../controller/ContactLeadDispositionController');
  contacts.contactleaddispositionmaster(req,res,next);
});

router.post('/insert-fba-contact-lead-disposition', function (req, res, next) { 
  var contacts = require('../controller/ContactLeadDispositionController');
  contacts.insertfbacontactleaddisposition(req,res,next);
});

router.post('/get-my-leads-edit', function(req, res, next) {
  var getmyleads = require('../controller/GetMyLeadsController');
    getmyleads.getmyleadsedit(req,res,next);
});
