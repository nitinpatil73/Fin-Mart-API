...
var AddChildPosp = function(req, res, next) {
...
con.execute_proc('call InsertFBARegistration(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',fbadata,function(data) {
	...
	if(data[0][0].SavedStatus == 0){
		...
		SubPospEntry(data[0][0].FBAID,req, res, next);
		...
		var msg = "Dear " + req.body.FirstName + " " + req.body.LastName + " Welcome to Magic Finmart. Your Magic Finmart UserName is :" +req.body.EmailId +" and Password is :"+req.body.password  + "Please click on this mgfm.in/finapp to download " ;
