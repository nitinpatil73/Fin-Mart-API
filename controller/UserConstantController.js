			...
			if(data[0][0].Status != '1'){
		        ...
		        if(process.env.NODE_ENV == 'development'){
					if(data[0][0].POSPNo != null && data[0][0].POSPNo != ''){
						data[0][0].healthurl = "http://qa.policyboss.com/Health_Web/health_main.html?ss_id="+data[0][0].POSPNo+"&fb_id="+data[0][0].FBAId;
					}else{
						data[0][0].healthurl = "http://qa.policyboss.com/Health_Web/health_main.html?ss_id=5&fb_id="+data[0][0].FBAId;
					}
				}else{
					if(data[0][0].POSPNo != null && data[0][0].POSPNo != ''){
						data[0][0].healthurl = "http://qa.policyboss.com/Health_Web/health_main.html?ss_id="+data[0][0].POSPNo+"&fb_id="+data[0][0].FBAId;
