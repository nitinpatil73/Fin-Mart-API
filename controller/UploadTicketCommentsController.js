...
class UploadTicketCommentsController{};
String.prototype.replaceAll = function(target, replacement) {
  return this.split(target).join(replacement);
};
UploadTicketCommentsController.save=function(req,res){
 ...
 // console.log("before" )
  ...
  upload(req, res, function (err) {
    //console.log("uploading....")
      ...
      DocName = Math.floor(Date.now() / 1000);      
          ...
          console.log(err);
         ...
         else
           {
                  ...
                  console.log(newFilePath);
                    ...
                    doc_param.push('TicketComment');                                        
                    doc_param.push(RBID);
                    doc_param.push(PBID);
                    doc_param.push(newFilePath);
                    //console.log("proc calling")
                    con.execute_proc('call upload_doc_ticket_comment(?,?,?,?,?)',doc_param,function(data) {
...
module.exports=UploadTicketCommentsController;